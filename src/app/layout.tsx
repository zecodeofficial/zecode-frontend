...
export const metadata: Metadata = {
  ...
  description: "ZECODE - Your New Fashion Code. Discover trendy, comfortable, and affordable urban clothing at 50+ stores across India.",
  keywords: ["urban fashion", "streetwear", "casual essentials", "Bengaluru", "clothing brand", "ZECODE", "affordable fashion"],
  authors: [{ name: "ZECODE" }],
  creator: "ZECODE",
  publisher: "ZECODE",
  robots: {
  ...
  openGraph: {
    ...
    description: "Your New Fashion Code. Trendy, comfortable, and affordable urban clothing.",
    images: [
      {
        url: "/brand/zecode-og.png",
        width: 1200,
        height: 630,
        alt: "ZECODE - Your New Fashion Code",
      },
    ],
  },
  twitter: {
